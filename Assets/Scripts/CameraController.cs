...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(transform.position != targetPoint[camposIndex].position && !isMoveDone)
        {
            ...
            {
                direction =
              new Vector3(targetPoint[camposIndex].parent.parent.gameObject.GetComponent<ShelfHub>().Shelfname.gameObject.transform.position.x,
              targetPoint[camposIndex].parent.parent.gameObject.GetComponent<ShelfHub>().Shelfname.gameObject.transform.position.y / 3 * 2,
              targetPoint[camposIndex].parent.parent.gameObject.GetComponent<ShelfHub>().Shelfname.gameObject.transform.position.z) - transform.position;
            }
            catch
            {
                direction =
              new Vector3(targetPoint[camposIndex].parent.gameObject.GetComponent<BinHub>().BinName.gameObject.transform.position.x,
              targetPoint[camposIndex].parent.gameObject.GetComponent<BinHub>().BinName.gameObject.transform.position.y / 3 * 2,
              targetPoint[camposIndex].parent.gameObject.GetComponent<BinHub>().BinName.gameObject.transform.position.z) - transform.position;
            }
            //if (targetPoint[camposIndex].parent.parent.gameObject.GetComponent<ShelfHub>()!=null)
            //{
               
            //}
            //if(targetPoint[camposIndex].parent.parent.gameObject.GetComponent<BinHub>() != null)
            //{
